        ...
        <section class="section">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        <form action="datadosen">
                            <button type="submit" class="card-icon bg-danger">
                                <i class="far fa-user"></i>
                            </button>
                        </form>
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>Data Dosen Praktikum</h4>
                            </div>
                            <div class="card-body">
                                4
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="card card-statistic-1">
                        <button class="card-icon bg-primary">
                            <i class="far fa-user"></i>
                        </button>
                        <div class="card-wrap">
                            <div class="card-header">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    @if (auth()->user()->level == "admin")
                    <div class="card card-statistic-1">
                        <button class="card-icon bg-warning">
                            <i class="far fa-file"></i>
                        </button>
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>Laporan Data BHP</h4>
                            </div>
                            <div class="card-body">
                                12
                            </div>
                ...
                <section class="section">
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card mt-3 mb-3">
                            <div class="card-header">
                                <h4>Data Statistik Penggunaan BHP</h4>
